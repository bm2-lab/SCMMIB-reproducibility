...
params:
  task:
    - task_mosaic_scRNA_ADT
  accuracy_datasets:
    - BMMC_CITE-seq_s2d1_s3d6
  robustness_datasets:
    - BMMC_CITE-seq_s2d1_s3d6
    - BMMC_CITE-seq_c5k_cnk	
  scalability_datasets:
    - mosaic_rna_adt_scal_line.jpg
---
...
This page shows the performance of different methods under all **mosaic scRNA + ADT** integration tasks in terms of accuracy, robustness and sclability.
...
<a data-fancybox href="figures/scalability_plot/mosaic_rna_adt_scal_line.jpg">
  <img src="figures/scalability_plot/mosaic_rna_adt_scal_line.jpg">
</a>
